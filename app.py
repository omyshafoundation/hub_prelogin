...
#             top_three_students = students[:3]
           #return render_template('leaderboard.html', data=data_for_template,mentions=result,top_three_students=top_three_students, students=students)
            return render_template('leaderboard.html', data=data_for_template)
